...
document.addEventListener("DOMContentLoaded", () => {
  fetch("http://localhost:8080/bank/admin/request-count")
  ...
  fetch("http://localhost:8080/bank/admin/customers/count")
    .then(response => response.json())
    .then(data => {
	...
	fetch("http://localhost:8080/bank/admin/accounts/status-count")
	  .then(response => response.json())
	  .then(data => {
	  ...
	  fetch("http://localhost:8080/bank/admin/accounts/type-count")
	    .then(response => response.json())
	    .then(data => {
	      const labels = Object.keys(data);
	      const values = Object.values(data);
